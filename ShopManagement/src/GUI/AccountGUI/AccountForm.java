...
public class AccountForm extends JPanel {
    ...
    public void initComponents() {
        ...
        btnUpdate.setIcon(new ImageIcon(AccountForm.class.getResource("/images/edit-icon.png")));
        ...
        btnAdd.setIcon(new ImageIcon(AccountForm.class.getResource("/images/add-user 24.png")));
        ...
        btnExportExcel.setIcon(new ImageIcon(AccountForm.class.getResource("/images/excel.png")));
        ...
        btnFilter.setIcon(new ImageIcon(AccountForm.class.getResource("/images/search-icon.png")));
        ...
        lblImage.setIcon(new ImageIcon(AccountForm.class.getResource("/images/employee 128.png")));
    ...
    public void addEvents() {
        ...
        btnAdd.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                btnConfirm.addMouseListener(new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        if (txtEmployeeName.getText().trim().isEmpty() || txtEmail.getText().trim().isEmpty() || txtAddress.getText().trim().isEmpty() ||
                            txtBirthday.getText().trim().isEmpty() || txtPhone.getText().trim().isEmpty() || txtCMND.getText().trim().isEmpty() ||
        ...
        btnUpdate.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                int row = tblEmployee.getSelectedRow();
                if (row < 0) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn nhân viên cần sửa!");
                    return;
                }
